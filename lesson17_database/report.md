...
VM2 (192.168.1.181) выступает в роли удаленного сервера-хранилища бэкапов. На ней создал пользователя под которым будет подключаться VM1, на которой БД. Также создал каталог для бэкапов и установил сервер ssh
...
Добавляю запись в `crontab -e` для автоматического бэкапа раз в день в 03:00
