...
При выполнении появляются варнинги, которые предупреждают о том, что если на удаленной машине появится интерпретатор, то разные модули ansible могут начать использовать его, что приведет к неожиданным результатам.
