...
Создал файл с тестовыми данными `deduplicate_input`.

Составил выражение для поиска дублирующих слов:
...
![Скриншот](screens/l13-t3-1.png)

Убрать дубли можно с помощью команды `sed`

Результат:

![Скриншот](screens/l13-t3-2.png)